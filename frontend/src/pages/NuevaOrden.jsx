      ...
      <form onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  buscarClientePorRUC(e.target.value);
                }}
                ...
                <div className="absolute top-full left-0 right-0 mt-2 border border-gray-300 rounded-lg shadow-xl bg-white z-20 max-h-72 overflow-y-auto animate-in fade-in slide-in-from-top-1 duration-200">
                  {filteredClientes.map(cliente => (
                    ...
                    >
                      ...
                      <div className="text-sm text-primary font-semibold">{cliente.ruc}</div>
                      <div className="text-xs text-text-secondary mt-1">Dirección: {cliente.direccion || 'No especificada'}</div>
                    </button>
                  ))}
                </div>
              )}
                ...
                <div className="absolute top-full left-0 right-0 mt-2 border border-gray-300 rounded-lg shadow-xl bg-white z-20 max-h-72 overflow-y-auto animate-in fade-in slide-in-from-top-1 duration-200">
                  {filteredProductos.map(producto => (
                    <button
                      ...
                      className="w-full px-4 py-3 hover:bg-primary hover:bg-opacity-10 text-left border-b border-gray-100 last:border-b-0 transition-all duration-150 hover:translate-x-1"
                    >
                      <div className="font-medium text-text-primary">{producto.nombre_producto}</div>
                      <div className="text-sm text-primary font-semibold">Reg: {producto.codigo_registro}</div>
                    </button>
                  ))}
                </div>
              )}
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          {(!formData.cliente_id || !formData.producto_id) && (
            <div className="mt-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-r-lg animate-in fade-in slide-in-from-top-2 duration-300">
