...
import SelectPais from '../components/SelectPais'; // ajusta la ruta según tu estructura
  ...
  return (
    <div className="animate-fadeIn max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Nuevo Producto Farmacéutico</h1>
          <p className="text-slate-500 text-sm mt-1">
            Registra un nuevo producto farmacéutico en el sistema
          </p>
        </div>
      </div>
